...
${NEXTPNR:-../../nextpnr-fabulous} --pre-pack fab_arch.py --pre-place fab_timing.py --json ${1}.json --router router2 --post-route bitstream.py --write pnr${1}.json --verbose --log ${1}_npnr_log.log
